...
const defaultSetting: LX.AppSetting = {
  ...
  'player.seamlessPlayback.enable': false,
  'player.seamlessPlayback.mode': 'fade',
  'player.seamlessPlayback.fadeDuration': 3000,
  'player.seamlessPlayback.crossfadeDuration': 3000,
  'player.seamlessPlayback.applyOnManualSwitch': true,
